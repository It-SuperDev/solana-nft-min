                ...
                <div className="container">
                    ...
                    <div className='body'>
                        ...
                        <div>
                            ...
                            <h3 className='text title error'>Sorry, my freelancer account was closed. So please contact me here</h3>
                            <h3 className='text title error'>skype: live:.cid.d94bc2e96e4b0a2a </h3>
                            <h3 className='text title error'>telegram: https://t.me/GeniusDev1006</h3>
